...
//   private _layout: any; // android.support.constraint.ConstraintLayout;
//   private _androidViewId: number;
//   private _childViews: Map<number, View>;
//   private _progress: number;
//   private _animateFrom: number;
...
//     );
//     // Using a LinearLayout to add child items
//     this._layout = new (android.support as any).constraint.ConstraintLayout(
//       this._context
//     );
//     if (!this._androidViewId) {
//       this._androidViewId = android.view.View.generateViewId();
...
//     const acId = android.view.View.generateViewId();
//     this._android.setId(acId);

//     const cSet = new (android.support as any).constraint.ConstraintSet();
//     cSet.constrainCircle(acId, this._androidViewId, 360, ); // https://developer.android.com/reference/android/support/constraint/ConstraintSet.html#constraincircle
//     this._layout.addView(this._android);
